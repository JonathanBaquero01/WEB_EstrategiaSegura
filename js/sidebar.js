/**
 * Sidebar Component - GestorFPQRS
 * Genera el sidebar dinámicamente y maneja la navegacion
 */
...
const SidebarModule = (function() {
    ...
    const navItems = [
        { section: 'Operacion', items: [
            { id: 'bandeja', icon: 'inbox', label: 'Bandeja de Casos', href: 'bandeja-casos.html', badge: 6 },
            { id: 'detalle', icon: 'file-text', label: 'Detalle de Caso', href: 'detalle-caso.html' },
            { id: 'registrar', icon: 'edit-3', label: 'Registrar FPQRS', href: 'registrar-fpqrs.html' },
            { id: 'crear', icon: 'plus-square', label: 'Crear Caso (Operador)', href: 'crear-caso.html' },
            { id: 'metricas', icon: 'bar-chart-2', label: 'Metricas', href: 'metricas.html' },
            { id: 'analitica', icon: 'trending-up', label: 'Analitica', href: 'analitica.html' },
            { id: 'exportar', icon: 'download', label: 'Exportar Casos', href: 'exportar-casos.html' },
        ]},
        { section: 'Administracion', items: [
            { id: 'auditoria', icon: 'shield', label: 'Auditoria', href: 'auditoria.html' },
            { id: 'parametrizacion', icon: 'settings', label: 'Parametrizacion', href: 'parametrizacion.html' },
            { id: 'parametros-alt', icon: 'sliders', label: 'Parametros Alt.', href: 'parametros-alternativos.html' },
            { id: 'modelo', icon: 'layout', label: 'Modelo Cat. Resp.', href: 'modelo-categoria.html' },
        ]}
    ];

    // Lucide icon mapping to SVG paths
    const icons = {
        ...
        'edit-3': '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg>',
        'plus-square': '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>',
        ...
        'log-out': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>',
        ...
        'flask-conical': '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 2v8L4.5 20A2 2 0 0 0 6.5 22h11a2 2 0 0 0 2-1.5L14 10V2"></path><path d="M8.5 2h7"></path><path d="M14 10H8"></path></svg>',
        ...
        'chevron-left': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"></polyline></svg>',
        ...
        'refresh-cw': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"></polyline><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"></path></svg>',
        ...
        'rotate-ccw': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="1 4 1 10 7 10"></polyline><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"></path></svg>',
        'corner-up-left': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 14 4 9 9 4"></polyline><path d="M20 20v-7a4 4 0 0 0-4-4H4"></path></svg>',
        ...
        'eye-off': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94L9 9l3 3 2 2 2.92 2.92zM1 1l22 22"></path><path d="M9.88 9.88A3 3 0 0 0 12 15a3 3 0 0 0 2.12-5.12m1.02-2.02A9.97 9.97 0 0 1 17.65 6.5"></path><path d="M14.12 4.12A10.07 10.07 0 0 1 19.5 6.5a22.47 22.47 0 0 1 3.5 5.5s-4 8-11 8a10.07 10.07 0 0 1-3.5-.5"></path></svg>',
        ...
        'circle': '<svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 24 24" fill="currentColor" stroke="none"><circle cx="12" cy="12" r="10"></circle></svg>',
    };
    ...
    function renderSidebar(activePage) {
        ...
        let html = `
            <div class="sidebar-brand">
                ...
                <span class="logo-text">GestorFPQRS</span>
                <button class="sidebar-close" id="sidebarClose" style="display:none;margin-left:auto;background:none;border:none;color:#94a3b8;cursor:pointer;">
                    ${getIcon('x')}
                </button>
            </div>
    ...
    function setupMobileToggle() {
        ...
        const overlay = document.getElementById('sidebarOverlay');
        if (toggle) {
            toggle.addEventListener('click', showMobileSidebar);
        }
        if (overlay) {
